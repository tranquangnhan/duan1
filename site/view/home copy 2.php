  ...
  <header>
        ...
        <div class="row">
          ...
          <div class="col-sm d-none d-sm-block line_h_28">
            <ul class="float-right margin-0px text-white mr-0">
              <li class="list-inline-item  padding-right-10px"><a class="text-white" href="page-login-2.html"><i class="fa fa-lock padding-right-5px"></i> Đăng Ký</a></li>
              <li class="list-inline-item"><a class="text-white" href="page-login-1.html"><i class="fa fa-user-plus padding-right-5px"></i> Đăng Nhập</a></li>
            </ul>
          </div>
        </div>              
      </div>
    ...
    <div class="header-output">
      <div class="container header-in">
        <div class="row">
          <div class="col-lg-3">
            <a id="logo" href="01-home.html" class="d-inline-block margin-tb-10px"><img src="img/logo.png" alt=""></a>
          ...
          <nav class="navbar navbar-expand-lg navbar-light col-lg-9 aligh-items-right">
            <div class="collapse navbar-collapse  link-padding-tb-20px dropdown-dark d-flex justify-content-end " id="navbarNav">
              <ul class="navbar-nav  W-100" id="menu-main">
                ...
                <!-- <li class="nav-item">
                  <a class="pd-0" href="#"><i class="fa fa-lock padding-right-5px"></i> Đăng Ký</a>
                </li>
                <li class="nav-item">
                  <a class="pd-0" href="#"><i class="fa fa-user-plus padding-right-5px"></i> Đăng Nhập</a>
                </li> -->
              </ul>                             
            </div>
          </nav>         
        ...
        <div class="owl-stage-outer">
            <div class="owl-stage">
                ...
                <div class="owl-item">
                  ...
                  <img src="img/panner2.jpg" alt="">
                  <div class="anim-pn2">
                    <div class="anim1-pn2 animated fadeInUp">All Day Happy</div>
                    <div class="animate-delay-0p4s anim2-pn2 animated fadeInUp"><img src="img/5saodiscount.png" alt=""></div>
                ...
                <div class="owl-item">
                  <div class="pn2-img"></div>
                  <img src="img/panner3.jpg" alt="">
                  <div class="anim-pn3">
                    <div class="anim1-pn3 animated fadeInDown">plans your trip</div>
                    <div class="animate-delay-0p7s anim2-pn3 animated fadeInUp"><img src="img/86311-Holidays-today.png" alt=""></div>
                  </div>
                </div>
            </div>
          </div>
              ...
              <div class="row mr-top-10pt">
                <div class="col-md-6">
                  <div class="box-city background-white border mr-bot-6pt">
                    <div class="city-img mr-right-4pt float-left box-img-hotcity"><a href="#"><img src="img/citie-1.jpg" alt=""></a></div>
                    <div class="city-body">
                      <div class="pd-14px">
                        <!--  -->
                ...
                <div class="col-md-6">
                  <div class="box-city background-white border mr-bot-6pt">
                    <div class="city-img mr-right-4pt float-left box-img-hotcity"><a href="#"><img src="img/citie-2.jpg" alt=""></a></div>
                    <div class="city-body">
                      <div class="pd-14px">
                ...
                <div class="col-md-6">
                  <div class="box-city background-white border mr-bot-6pt">
                    <div class="city-img mr-right-4pt float-left box-img-hotcity"><a href="#"><img src="img/citie-3.jpg" alt=""></a></div>
                    <div class="city-body">
                      <div class="pd-14px">
                ...
                <div class="col-md-6">
                  <div class="box-city background-white border mr-bot-6pt">
                    <div class="city-img mr-right-4pt float-left box-img-hotcity"><a href="#"><img src="img/citie-4.jpg" alt=""></a></div>
                    <div class="city-body">
                      <div class="pd-14px">
    ...
    <div class="background-light-grey W-100 pd-t-100px pd-bot-50px">
            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active background-white padding-30px border">
                    <div class="float-left mr-right-20px"><img src="img/avt-1.jpg" alt=""></div>
                ...
                <div class="carousel-item background-white padding-30px border">
                  <div class="float-left mr-right-20px"><img src="img/avt-2.png" alt=""></div>
                ...
                <div class="carousel-item background-white padding-30px border">
                  <div class="float-left mr-right-20px"><img src="img/avt-3.png" alt=""></div>
                ...
                <!-- <div class="carousel-item background-white padding-30px border">
                  <div class="float-left mr-right-20px"><img src="img/avt-4.png" alt=""></div>
                  <h5 class="text-medium cl-te-black text-uppercase">Rabie Elkheir</h5>
      ...
      <div class="ins-img">
        <div class="box-ins-img">
          <img src="img/instagram-1.jpg" class="img-fluid" alt="Responsive image">
        </div>
        <div class="box-ins-img">
          <img src="img/instagram-2.jpg" class="img-fluid" alt="Responsive image">
        </div>
        <div class="box-ins-img">
          <img src="img/instagram-3.jpg" class="img-fluid" alt="Responsive image">
        </div>
        <div class="box-ins-img">
          <img src="img/instagram-4.jpg" class="img-fluid" alt="Responsive image">
        </div>
        <div class="box-ins-img">
          <img src="img/instagram-5.jpg" class="img-fluid" alt="Responsive image">
        </div>
        <div class="box-ins-img">
          <img src="img/instagram-6.jpg" class="img-fluid" alt="Responsive image">
        </div>
        <div class="box-ins-img">
          <img src="img/instagram-7.jpg" class="img-fluid" alt="Responsive image">
        </div>
        <div class="box-ins-img">
          <img src="img/instagram-8.jpg" class="img-fluid" alt="Responsive image">
        </div>
        <div class="box-ins-img">
          <img src="img/instagram-9.jpg" class="img-fluid" alt="Responsive image">
        </div>
        <div class="box-ins-img">
          <img src="img/instagram-10.jpg" class="img-fluid" alt="Responsive image">
        </div>
      </div>
    </div>
  </div>
  <footer class="te-al-left">
    <div class="container">
      <div class="row pd-tb-100px">
        <div class="col-lg-6">
          <div class="">
            <div class="logo mr-bot-20px"><a href="#"><img src="img/logo.png" alt=""></a></div>
            ...
            <div class="">
              <div class="logo mr-bot-20px d-inline-block pd-right-50px"><a href="#"><img src="img/vietject.png" alt=""></a></div>
              <div class="logo mr-bot-20px d-inline-block pd-right-50px"><a href="#"><img src="img/vietnameairline.png" alt=""></a></div>
              <div class="logo mr-bot-20px d-inline-block pd-right-50px"><a href="#"><img src="img/pacific.png" alt=""></a></div>
              <div class="logo mr-bot-20px d-inline-block pd-right-50px"><a href="#"><img src="img/bambo.png" alt=""></a></div>            
            </div>
          </div>
        </div>
        <div class="col-lg-3">
        ...
        <div class="col-lg-3">
          <div class="col-4 padding-tb-7px dl-inline-block float-left">
            <img src="img/instagram-1.jpg" class="img-fluid pd-lr-5px" alt="Responsive image">
          </div>
          <div class="col-4 padding-tb-7px dl-inline-block float-left">
            <img src="img/instagram-2.jpg" class="img-fluid pd-lr-5px" alt="Responsive image">
          </div>
          <div class="col-4 padding-tb-7px dl-inline-block float-left">
            <img src="img/instagram-3.jpg" class="img-fluid pd-lr-5px" alt="Responsive image">
          </div>
          <div class="col-4 padding-tb-7px dl-inline-block float-left">
            <img src="img/instagram-4.jpg" class="img-fluid pd-lr-5px" alt="Responsive image">
          </div>
          <div class="col-4 padding-tb-7px dl-inline-block float-left">
            <img src="img/instagram-5.jpg" class="img-fluid pd-lr-5px" alt="Responsive image">
          </div>
          <div class="col-4 padding-tb-7px dl-inline-block float-left">
            <img src="img/instagram-6.jpg" class="img-fluid pd-lr-5px" alt="Responsive image">
          </div>
        </div>
      </div>
      <div class="row border-top-grey-1 pd-tb-30px">
        ...
        <div class="col-4">
          <div class="text-center"><img src="img/cardspay.png" alt=""></div>
        </div>
        <div class="col-4">
