                ...
                <div class="row">
                    ...
                    <div class="col-sm d-none d-sm-block line_h_28">
                        <ul class="user-area list-inline float-right margin-0px text-white">
                            <li class="list-inline-item  padding-right-10px"><a class="text-white" href="page-login-2.html"><i class="fa fa-lock padding-right-5px"></i> login</a></li>
                            <li class="list-inline-item"><a class="text-white" href="page-login-1.html"><i class="fa fa-user-plus padding-right-5px"></i> register</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="container header-in">
                <div class="row">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light col-lg-9">
                        <div class="collapse navbar-collapse float-right link-padding-tb-20px dropdown-dark" id="navbarNav">
                ...
                <div id="search-filter-2" class="search-filter pull-top-80px z-index-100 position-relative">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item filght">
                            <a class="nav-link a_filght text-white" data-toggle="tab" href="#home" role="tab"><i class="fas fa-plane-departure"></i> Flights</a>
                        </li>
                    </ul>
                    <!-- Tab panes -->
                        ...
                        <div class="tab-pane active" id="home" role="tabpanel">
                            <div class="row">
                                ...
                                <div class="form-group col-lg-2">
                                    ...
                                    <div class="date-input"><input type="text" class="input-text datepicker full-width hasDatepicker" placeholder="15 / 5 / 2017" id="dp1604379882087"></div>
                                </div>
                                <div class="col-lg-2">
                                    <label>Ticket</label>
                                ...
                                <div class="col-lg-2">
                                    <a href="#" class="btn-sm btn-lg btn-block background-main-color text-white text-center text-uppercase font-weight-600 margin-top-30px padding-7px"> Hotel  Search</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mr-top-10">
                        <div class="col-sm-6 col-lg-3 sm-mb-30px te-al-left">
                            <div class="hotel-grid background-white border border-grey-1">
                                ...
                                <div class="padding-20px">
                                    <h3 class="text-uppercase"><a href="#" class="text-dark fz-14vw">Adel New Hotel</a></h3>
                        ...
                        <span class="text-third-color margin-right-5px">United Kingdom</span> London</a>
                                    ...
                                    <div class="margin-bottom-8px text-uppercase font-small mr-tb-2">
                                        <strong class="font-medium text-third-color padding-right-5px font-weight-bold">$500</strong>Person
                                    </div>
                                    <a href="#" class="btn-sm btn-lg btn-block background-main-color text-white text-center font-weight-bold text-uppercase rounded-0">Booking Now </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-3 sm-mb-30px">
                            <div class="hotel-grid background-white border border-grey-1 te-al-left">
                                ...
                                <div class="padding-20px">
                                    <h3 class="text-uppercase"><a href="#" class="text-dark fz-14vw">Anwar City Hotel</a></h3>
                                    <small class="text-uppercase">
                      <a href="#" class="cl-grey "><i class="fa fa-map-marker margin-right-5px"></i>
                      <span class="text-third-color margin-right-5px">United Kingdom</span> London</a>
                    </small>
                        ...
                        <div class="col-sm-6 col-lg-3 sm-mb-30px">
                            <div class="hotel-grid background-white border border-grey-1 te-al-left">
                                ...
                                <div class="padding-20px">
                                    <h3 class="text-uppercase"><a href="#" class="text-dark fz-14vw">Gadi Elsir Hotel</a></h3>
                                    <small class="text-uppercase">
                  <a href="#" class="cl-grey "><i class="fa fa-map-marker margin-right-5px"></i>
                  <span class="text-third-color margin-right-5px">United Kingdom</span> London</a>
                </small>
                        ...
                        <div class="col-sm-6 col-lg-3 sm-mb-30px">
                            <div class="hotel-grid background-white border border-grey-1 te-al-left">
                                ...
                                <div class="padding-20px">
                                    <h3 class="text-uppercase"><a href="#" class="text-dark fz-14vw">FILGHT TO JAPAN</a></h3>
