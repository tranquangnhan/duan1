    ...
    <footer>
        <div class="container">
            <div class="row padding-tb-100px">
                <div class="col-lg-6">
                    <div class="about">
                        <div class="logo margin-bottom-20px"><a href="#"><img src="img/logo.png" alt=""></a></div>
                        <p class="text-grey-2">
                ...
                <div class="col-lg-3">
                    <ul class="images-feed row no-gutters margin-0px padding-0px list-unstyled">
                        <li class="col-lg-6 col-md-6 padding-tb-5px"><a href="#" class="padding-lr-5px d-block"><img src="img/instagram-1.jpg" alt=""></a></li>
                        <li class="col-lg-6 col-md-6 padding-tb-5px"><a href="#" class="padding-lr-5px d-block"><img src="img/instagram-2.jpg" alt=""></a></li>
                        <li class="col-lg-6 col-md-6 padding-tb-5px"><a href="#" class="padding-lr-5px d-block"><img src="img/instagram-3.jpg" alt=""></a></li>
                        <li class="col-lg-6 col-md-6 padding-tb-5px"><a href="#" class="padding-lr-5px d-block"><img src="img/instagram-4.jpg" alt=""></a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row padding-tb-30px border-top-1 border-grey-1">
                ...
                <div class="col-lg-4 sm-mb-20px">
                    <div class="text-center"><img src="img/cards.png" alt=""></div>
                </div>
                <div class="col-lg-4">
